...
DEFAULT_ROOT_PATH="${UPDATE_REPOS_ROOT:-$HOME/repos}"
...
CHILD_FOLDER_PREFIX="${UPDATE_REPOS_PREFIX:-Hydra}"  # Use H for all or Htec for SLIBs
# -------------------------------------------------------------------------
...
Options:
  ...
  --prefix <prefix>        Child folder prefix to match as repos (default: Hydra, '' for all)
