...
| **Path variables** | `WIN_USER`, `REPOS_ROOT`, `MY_REPO` (drive letters and paths vary per machine) |
| **Personal aliases** | `cdrepo`, `downloads` (using `$WIN_USER` / `$REPOS_ROOT` — not hardcoded paths) |
